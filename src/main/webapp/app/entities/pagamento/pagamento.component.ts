...
export class PagamentoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.pagamentoService
      ...
      .subscribe(
        (res: HttpResponse<IPagamento[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IPagamento[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
