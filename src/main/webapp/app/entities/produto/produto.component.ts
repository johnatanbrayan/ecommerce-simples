...
export class ProdutoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.produtoService
      ...
      .subscribe(
        (res: HttpResponse<IProduto[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInProdutos(): void {
    this.eventSubscriber = this.eventManager.subscribe('produtoListModification', () => this.loadPage());
  }
