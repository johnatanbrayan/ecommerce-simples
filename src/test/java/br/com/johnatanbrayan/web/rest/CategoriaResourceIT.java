...
import br.com.johnatanbrayan.service.mapper.CategoriaMapper;
...
public class CategoriaResourceIT {
    ...
    public void createCategoria() throws Exception {
        ...
        assertThat(testCategoria.isStatus()).isEqualTo(DEFAULT_STATUS);
    }
    ...
    public void updateCategoria() throws Exception {
        ...
        assertThat(testCategoria.isStatus()).isEqualTo(UPDATED_STATUS);
    }
